...
let data0 = fs.readFileSync(path.join(__dirname, '../crypto-config/peerOrganizations/org2.example.com/msp/tlscacerts/tlsca.org2.example.com-cert.pem'));
let peer0 = fabric_client.newPeer(
    'grpcs://localhost:9051',
    {
        pem: Buffer.from(data0).toString(),
        'ssl-target-name-override': 'peer0.org2.example.com'
    }
);
channel.addPeer(peer0);

let data2 = fs.readFileSync(path.join(__dirname, '../crypto-config/ordererOrganizations/example.com/tlsca/tlsca.example.com-cert.pem'));
